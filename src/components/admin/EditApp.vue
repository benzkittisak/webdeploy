                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <form @submit.prevent="formSubmit" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-4">
                                <img :src="'http://uni-api.app.ruk-com.cloud/icon/'+app.icon" class="img-fluid" style="width:100%" alt="" id="preview_logo">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="preview_more">
                                            ...
                                            <div id="preview_app_list">
                                                <img class="del_preview" style='width:150px;object-fit:cover;height:150px' v-for="img in app.preview" :key="img" :src="'http://uni-api.app.ruk-com.cloud/icon/'+img"   @click="delImg(img)" alt="">
...
export default {
    ...
    created(){
        ...
        const apiURL = `http://uni-api.app.ruk-com.cloud/api/app/edit/${this.$route.params.id}`;
    ...
    methods:{
            ...
            try{
                axios.post('http://uni-api.app.ruk-com.cloud/upload/multi',formData).then(()=>{
                    axios.post('http://uni-api.app.ruk-com.cloud/upload',formData2).then(()=>{
                        const appURL = `http://uni-api.app.ruk-com.cloud/api/app/update/${this.$route.params.id}`;
        ...
        delImg(img){
            let pos = this.app.preview.indexOf(img)
            this.app.preview.splice(pos,1);
        }
    }
}
